...
class ElsClient:
    ...
    def __init__(self, api_key, inst_token=None, num_res=25, local_dir=None):
        # TODO: make num_res configurable for searches & documents/authors view
        #   - see https://github.com/ElsevierDev/elsapy/issues/32
        # JAK NOTE: num_res is not used in the code below
        """Initializes a client with a given API Key and, optionally,
            institutional token, number of results per request, and local data
            path.
        """
    ...
    def exec_requestPUT(self, URL, params=None):
        """Sends the actual request using PUT method; returns response.
